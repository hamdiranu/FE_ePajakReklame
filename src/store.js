...
export const actions = store => ({
  ...
  getDataOfficer: async (state, event) => {
    const req = {
      ...
      headers: {
        Authorization: "Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..KIdLzrKKWGK_3TpTggTVcnEAqqUJBbzGvFqaoMqjP7c"
      }
    };
